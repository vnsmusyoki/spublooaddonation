                ...
                <main>
                    ...
                    <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="text"  name="drivename"   />
                                            </div> 
                                            ...
                                            <div class="form-group">
                                             ...
                                             <?php
                                                        if(isset($_POST['uploadgroup'])){
                                                            ...
                                                            $insert = "INSERT INTO `donation_drive`(`donation_drive_date`, `donation_drive_location`, `donation_drive_name`, `donation_drive_desc`, `donation_institution_id`) VALUES ('$dates', '$location', '$drivename', '$description', '$institution')";
