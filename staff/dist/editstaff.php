...
$data = "SELECT * FROM `staff` WHERE `staff_id` = '$record'";
        $query = mysqli_query($conn, $data);
        while($fetch = mysqli_fetch_assoc($query)){
            $staffid = $fetch['staff_id']; 
            $staffdob = $fetch['staff_dob'];  
            $staffname = $fetch['staff_name'];  
            $staffnumber = $fetch['staff_phone_number'];  
            $staffemail = $fetch['staff_email'];  
            $staffidnumber = $fetch['staff_national_id'];  
            $staffroles = $fetch['staff_role'];  
            $staffinstitution = $fetch['staff_institution_id'];  
            ...
            global $staffnumber;    
            global $staffemail;    
            global $staffidnumber;    
            global $staffroles;    
            global $staffinstitution;    
        }
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-10 py-4">
                            <form style="background-color:white;padding:2rem 1rem;margin-top:5rem;" method="POST" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" type="text" name="fullnames" value="<?php echo $staffname; ?>" />
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputFirstName">ID Number</label>
                                            <input class="form-control py-4" type="number" name="idnumber" min="10000000" value="<?php echo $staffidnumber; ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputFirstName">Phone Number</label>
                                            <input class="form-control py-4" type="number" name="phone" min="0700000001" max="0799999999" value="<?php echo $staffnumber; ?>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" type="date" name="dates" value="<?php echo $staffdob; ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="inputEmailAddress" type="email" name="email" value="<?php echo $staffemail; ?>" />
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="rolseassigned" id="" cols="30" rows="10" class="form-control py-4"><?php echo $staffroles; ?></textarea>
                                        </div> 
                                <button type="submit" class="btn btn-primary btn-block" name="uploadgroup">Update Staff Account</button>
                                <?php
                                if (isset($_POST['uploadgroup'])) {
                                    ...
                                    if (empty($dates) || empty($duties) || empty($institution) || empty($gender) || empty($email) || empty($idnumber) || empty($fullnames) || empty($phone)) {
                                        ...
                                        $insert = "UPDATE `staff` SET `staff_name`='$fullnames', `staff_national_id`='$idnumber', `staff_sex`='$gender', `staff_dob`='$dates', `staff_phone_number`='$phone', `staff_email`='$email', `staff_role`='$duties', `staff_ institution_id`='$institution' WHERE `staff_id`='$staffid'";
                                        ...
                                        if ($querys) {
                                            ...
                                            while($fetch= mysqli_fetch_assoc($checkstaff)){
                                                $stafffs = $fetch['staff_id'];
                                                $password = md5($idnumber);
                                               $addlogin = "UPDATE `login` SET `login_user_name`='$email', `login_password`='$password' WHERE  `login_staff_id`='$stafffs'";
