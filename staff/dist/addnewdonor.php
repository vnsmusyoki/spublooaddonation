                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="addnewdonor.php">Add Donor</a> 
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" type="text" name="county"  />
                                        </div>
                                    </div>
                                     
                                </div>
                                
                                <button type="submit" class="btn btn-primary btn-block" name="uploadgroup">Upload Donor Data</button>
                                <?php
