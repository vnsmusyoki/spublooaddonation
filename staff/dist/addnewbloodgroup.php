                ...
                <main>
                    ...
                    <hr>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <button type="submit" class="btn btn-primary btn-block" name="uploadgroup">Upload Blood Group</button>
                                             <?php
                                                        if(isset($_POST['uploadgroup'])){
                                                            ...
                                                            $insert = "INSERT INTO  `blood_group` (`blood_group_name`, `blood_group_desc`) VALUES('$groupname', '$description')";
