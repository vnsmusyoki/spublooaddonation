...
$user = "SELECT * FROM `donor` WHERE `donor_email` = '$email'";
...
<head>
    ...
    <title> Donor | Blood DOnation</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid" style="padding-top: 3rem;">
                    <center>
                        <h3>Upcoming Donations In My County</h3>
                    </center>
                    <table class="table table-bordered" id="allalerts">
                        ...
                        <tbody>
                            ...
                            include '../dbconnection.php';
                           $data = "SELECT * FROM `donation_drive`  WHERE `donation_drive_location` = '$county'";
                            $query = mysqli_query($conn, $data);
                            while ($fetch = mysqli_fetch_assoc($query)) {
                                $record = $fetch['donation_drive_date'];
                                $hospital = $fetch['donation_institution_id'];
