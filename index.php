...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body> 
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-12">
                            ...
                            <p>
                                <span><i class="fa fa-building-o"></i> <strong>Contact: </strong>  Nairobi</span>
                                <span>&nbsp;<i class="fa fa-phone"></i> <strong>Call Us:</strong> +254 7 111 222 33</span>
                            </p>
        ...
        <section class="section-banner" data-bg_img="images/home_1_slider_2.jpg" data-bg_color="#111111" data-bg_opacity="0.1" >
        ...
        <section class="section-content-block section-process" id="ourcampaigns" >
            ...
            <div class="container">
                ...
                <div class="row margin-top-48">
                    ...
                    <div class="event-carousel owl-carousel"  data-nav="true" data-dots="false">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="event-layout-1 theme-custom-box-shadow clearfix"> 
                                ...
                                <div class="event-info">  
                                    ...
                                    <div class="event-exceprt">awareness and timely access to safe blood and blood products as part of a comprehensive approach to prevent maternal and child deaths</div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 text-center">
                        <a class="btn btn-theme margin-top-48" href="#">Load All Campaigns</a>
                    </div>
                </div>
            ...
            <div class="container wow fadeInUp">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-md-offset-4 text-center">
                        <a href="#" class="btn btn-theme margin-top-48">- Load More Blog -</a>
                    </div>
                </div> <!-- end .row  -->
            ...
            <section class="footer-contents">
                ...
                <div class="container">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 col-sm-12 text-center">
                            <p class="copyright-text"> Copyright 2021 - Blood Buddies . All Rights Reserved. </p>
                        </div>  <!-- end .col-sm-6  -->
